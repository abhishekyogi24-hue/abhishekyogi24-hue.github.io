...
# ABOUT ABHISHEK YOGI
AI Product Manager with 7+ years building and scaling 0→1 and growth-stage products across AI, platforms, and B2B SaaS — targeting both AI Product Manager and Platform Integrations roles. Has shipped AI chatbots driving $1M+ monthly revenue, 55% automation, and a 12% AHT (average handle time) reduction. Owns the full product lifecycle — strategy, GTM, and execution — across Engineering, Data, Marketing, and Operations. Deep experience in conversational AI, RAG systems, monetization, and API-driven platform integrations — including Vertex AI, WhatsApp Cloud API, and NICE CX platform integrations owned end-to-end. Based in Gurugram, Haryana, India.
